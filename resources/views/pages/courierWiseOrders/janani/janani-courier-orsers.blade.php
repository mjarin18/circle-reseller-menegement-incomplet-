        ...
        {{-- <div class="col-md-12"> --}}
          <div class="card">
            ...
            <th style="width:15%">Order ID</th>
                ...
                <tbody>
                   @foreach ($janani_orders as $order)
                   <tr> 
                    <td>{{$order->date}}</td> 
                    <td>{{$order->code}}</td>
                    ...
                    <td>
{{-- Update button.......................................................--}}                        
<button type="button" class="btn btn-success btn-sm btn-flat btn-janani-order" value="{{$order->id}}" 
data-toggle="modal" data-target="#janani_order_modal_id">
<i class="fa fa-edit"></i></button>
 {{-- View button.......................................................--}} 
<a href="{{url('view-single-janani-order/'.$order->id)}}">
