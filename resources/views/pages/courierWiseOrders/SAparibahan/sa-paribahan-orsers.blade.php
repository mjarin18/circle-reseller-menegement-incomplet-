...
<section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>SA Paribahan Orders List</h1> 
        </div>
        <div class="col-sm-6">
        ...
        {{-- <div class="col-md-12"> --}}
          <div class="card">
            ...
            <th style="width:15%">Order ID</th>
                ...
                <tbody>
                   @foreach ($sa_paribahan_orders as $order)
                   <tr> 
                    <td>{{$order->date}}</td> 
                    <td>{{$order->code}}</td>
                    <td>Style Heaven</td> 
                    ...
                    <td>
{{-- Update button.......................................................--}}                        
<button type="button" class="btn btn-success btn-sm btn-flat btn-sa-paribahan-order" value="{{$order->id}}" 
data-toggle="modal" data-target="#sa_paribahan_order_modal_id">
<i class="fa fa-edit"></i></button>
 {{-- View button.......................................................--}} 
<a href="{{url('view-single-sa-paribahan-order/'.$order->id)}}">
...
{{-- Modal for update--}}
 @include('layouts.inc.CourierWiseOrders.SAparibahan.sa-paribahan-order-update-modal') 
</div>
</div>
</div>
