                    ...
                    <div class="card-body scrollable">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <table class="table table-bordered table-hover data_table  no-footer" role="grid">
                                <thead>
                                <tr role="row">
                                <th style="width:5%" rowspan="1" colspan="1">Product SKU</th>
                                <th style="width:10%" rowspan="1" colspan="1">Product Name</th>
                                <th style="width:5%" rowspan="1" colspan="1">Product Variant</th>
                                ...
                                <th style="width:5%" rowspan="1" colspan="1">Tools</th></tr>
                                </tr>
                                </thead>
                                <tbody>
