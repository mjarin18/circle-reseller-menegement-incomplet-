            ...
            <th style="width:5%">SKU</th>
                ...
                <tbody>
                   ...
                   <tr> 
                    ...
                    <td>
{{-- Update Button --}}
<button class="btn btn-success btn-sm btn-block edit-no-status-order-deatails" value="{{$order->id}}" data-toggle="modal" 
data-target="#no_status_order_details_id"><i class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Update</button><br>
{{-- Returned Button --}}
<button class="btn btn-info btn-sm btn-block returned-no-status-order-btn" value="{{$order->id}}" data-toggle="modal" 
data-target="#no_status_order_returned_id"><i class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Returned</button><br> 
{{-- Purchased Button --}}
<a href="{{url('purchased-no-status-order/'.$order->id)}}" target="”_blank”"><button class="btn btn-primary btn-block"><i class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Purchased</button></a> <br>
