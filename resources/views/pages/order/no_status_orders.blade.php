        ...
        {{-- <div class="col-md-12"> --}}
          <div class="card">
            ...
            <th style="width:15%">Order ID</th>
                 ...
                 <th style="width:15%">Ordered Items</th>
                ...
                <tbody>
                   @foreach ($no_status_orders as $order)
                   <tr> 
                    <td>{{$order->date}}</td> 
                    <td>{{$order->code}}</td>
                    ...
                    <td>
{{-- Update button.......................................................--}}                        
<button type="button" class="btn btn-success btn-sm btn-flat btn-no-status-order" value="{{$order->id}}" 
data-toggle="modal" data-target="#no_status_order_modal_id">
...
{{-- Modal for update--}}
 @include('layouts.inc.NoStatusOrders.no-status-orders-update-modal') 
</div>
</div>
</div>
