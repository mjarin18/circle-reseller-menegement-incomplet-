            ...
            <th style="width:5%">SKU</th>
                ...
                <tbody>
                   ...
                   <tr> 
                    ...
                    <td>{{$order->date}}</td> 
                    <td>TS2983</td>
                    <td>Premium Quality Exclusive Polo shirt For Men TS2983</td> 
                    <td><img src="{{asset('images/p-6.jpg')}}" alt="product_img"  style="width=120px; max-width:100px;"></td>
                    <td>
                    ...
                    <td>
{{-- Update Button --}}
<button class="btn btn-success btn-sm btn-block edit-btn-returning-order-deatails" value="{{$order->id}}" data-toggle="modal" 
data-target="#returning_order_details_id"><i class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Update</button><br>
{{-- Returned Button --}}
<button class="btn btn-info btn-sm btn-block returned-returning-order-btn" value="{{$order->id}}" data-toggle="modal" 
data-target="#returning_order_returned_id"><i class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Returned</button><br> 
{{-- Purchased Button --}}
<a href="{{url('purchased-returning-order/'.$order->id)}}" target="”_blank”"><button class="btn btn-primary btn-block"><i class="fa fa-edit"></i>&nbsp;&nbsp;&nbsp;Purchased</button></a> <br>
