<div class="modal fade" id="processing-order-returned_id" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-body px-5">
          ...
          <form id="form" class="form-horizontal" action="{{url('update-processing-order-returned')}}" method="POST">
           ...
           <div class="form-group row">
                ...
                <div class="col-sm-9">
                  <input type="text" class="form-control" id="refund" name="return_reason" required="">
                </div>
            </div> 
