<div class="modal fade" id="update-purchase-status-underReviewOrder" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" style="max-width: 700px!important;" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body px-5 py-5">
          {{-- Form Start.......................... --}}
          <form id="form" class="form-horizontal" action="{{url('underReviewOrder-update-purchase-status')}}" method="POST">
              @csrf
              @method('PUT')  
