    ...
    <div class="modal-dialog" style="max-width: 800px!important;" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body px-5">
          {{-- Form Start.......................... --}}
          <form id="form" class="form-horizontal" action="{{url('update-returned-no-status-order')}}" method="POST">
              @csrf
              @method('PUT')  
            <input type="hidden" name="no_status_returned_order_id" id="no_status_returned_order_id">
            <br><br>
           <div class="form-group row">
            ...
            <div class="text-center">
                ...
                <h2 id="no_status_returnedOrder" class="bold"></h2>  
            </div>
